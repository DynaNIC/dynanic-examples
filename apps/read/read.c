    ...
    struct measurement_settings *measurement)
{
    ...
    if (app_settings->disable_rss) {
        rte_log(RTE_LOG_INFO, RTE_LOGTYPE_EAL, "RSS disabled.\n");
        app_settings->dpdk.port_conf.rxmode.mq_mode = RTE_ETH_MQ_RX_NONE;
    } else {
