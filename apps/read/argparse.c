/* argparse.c: Argument parser for read example.
    ...
    struct application_settings *app_settings)
{
    ...
    app_settings->disable_rss = false;

    // Parse arguments
    set_app_args("t:hr", long_options);
...
void print_help()
{
    printf("Usage: ./read [EAL options] -- [Application options]\n");
    ...
    printf("\t -r, --disable-rss = Flag to disable RSS.\n");
